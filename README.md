...
Feel free to clone the course's repository onto your local machine via Github command line interface (CLI).

```
gh repo clone kaamanita/quantum-computing
```

This repository consists of the slides for each chapter as well as example source code. All materials are distributed under the CC-BY-NC 4.0 license.
